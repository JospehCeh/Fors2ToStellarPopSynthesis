...
@jit
def lik_mag(p_tofit, p_fix, xf, mags_measured, sigma_mag_obs, z_obs):
    """
...
@jit
def lik_ugri(p, xf, mags_measured, sigma_mag_obs, z_obs):
    """
    neg loglikelihood(parameters,x,y,sigmas) for the photometry
    """
    ...
    all_mags_predictions = mean_ugri(xf, params, z_obs)
    resid = mags_measured - all_mags_predictions
